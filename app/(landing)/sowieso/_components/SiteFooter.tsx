...
export function SiteFooter() {
  return (
    ...
    >
      ...
      >
        <div className="grid gap-6" style={{ gridTemplateRows: "1.2fr 0.8fr" }}>
          <Reveal
            className={`${styles.surfaceCard} ${styles.partnerTile} relative overflow-hidden`}
          >
            <a
              href="#psp-partners"
              className="block relative p-8 min-h-[240px]"
              style={{ color: "#1d1c1c" }}
            >
              <div className="font-[800] text-2xl uppercase max-w-[340px] leading-[0.95]">
                Always available with our PSP partners
              </div>
              <span
          ...
          <div className="grid grid-cols-2 gap-6">
            <Reveal className={`${styles.surfaceCard} relative bg-white`}>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-6 min-h-[160px] flex items-center justify-center relative"
              >
                <img
        ...
        <div className="grid gap-6" style={{ gridTemplateColumns: "1fr 84px" }}>
          <Reveal className={`${styles.surfaceCard} ${styles.faqTilePink} relative overflow-hidden`}>
            <a
              href="#veelgestelde-vragen"
              className="block relative p-8 min-h-[380px]"
              style={{ color: "#1d1c1c" }}
            >
              ...
              <div
                ...
                style={{
                  fontSize: "clamp(1.5rem, 2vw + 0.6rem, 2.5rem)",
                  lineHeight: 0.9,
          ...
          <div className={`${styles.surfaceCard} ${styles.faqTileGreen} flex flex-col items-center justify-center gap-4 p-4`}>
            {[
