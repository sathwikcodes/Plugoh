...
export function CampaignBrandSection({
  ...
  return (
    <div className="rounded-2xl border border-white/[0.09] bg-[linear-gradient(160deg,rgba(22,18,25,0.90)_0%,rgba(30,24,41,0.85)_100%)] backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.32),inset_0_1px_0_rgba(255,255,255,0.08)] p-4 sm:p-5">
      <p className="mb-3 text-[10px] uppercase tracking-[0.22em] text-white/35">
        Brand
      </p>
      {profilesLoading && !businessIdentity ? (
        <div className="flex items-center gap-3">
          <div className="h-12 w-12 shrink-0 animate-pulse rounded-2xl bg-[#211b2c]" />
