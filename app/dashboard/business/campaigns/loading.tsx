...
function CampaignCardSkeleton() {
  return (
    <m.div variants={fadeUp} className="relative rounded-[34px] border border-white/8 bg-card overflow-hidden aspect-[0.74] w-full">
      {/* Background image area placeholder */}
      <Skeleton className="absolute inset-0 rounded-none bg-white/[0.04]" />
      {/* Content overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-black/20 p-6 flex flex-col justify-between">
        {/* Top controls */}
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Mobile: single card stack layout */}
