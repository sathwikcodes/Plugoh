            ...
            {filtered.map((p) => {
              ...
              return (
                <m.div key={p.id} variants={fadeUp}>
                  <Card className="group transition-all hover:shadow-lg hover:border-white/20 bg-card/60 backdrop-blur-md border-white/10">
                    <CardContent className="p-5 space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button size="sm" className="h-10" asChild>
                          <Link href={`/dashboard/business/discover/${p.id}`}>
                            View Profile
                          </Link>
                        </Button>
                      </div>
