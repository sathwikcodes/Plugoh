        ...
        <>
          ...
          {isMobile ? (
            <m.div
              ...
              ref={panelRef}
              className="fixed bottom-0 left-0 right-0 z-50 flex h-[92dvh] max-h-[92dvh] flex-col overflow-hidden rounded-t-[32px] border-t border-white/10 bg-[#141414] text-white shadow-[0_-24px_60px_rgba(0,0,0,0.55)]"
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "100%" }}
